...
class cl_UpdateClient : protected cl_Screen
{
...
public:
	...
	static void Show_Update_client() {
		...
		if (!Check_access_rights(cl_User::en_Permissons::Update_Client)) {
			return;
		}

		string Account_number = "";
		cl_Screen::po_Draw_screen_header("\t   Update Client Screen");
